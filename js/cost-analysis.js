...
(function () {
    ...
    function buildHTML() {
        ...
        html += '<span style="font-size:11px;color:#16a34a;background:#f0fdf4;border:1px solid #bbf7d0;padding:3px 10px;border-radius:99px;font-weight:600;">✅ 実データ（t_sagyofl）</span>';
