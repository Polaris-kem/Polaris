...
(function () {
    ...
    function buildHTML() {
        return [
            ...
            '    </div>',
            '  </div>',
            '  <div id="bom-drop-area" style="display:flex;flex-direction:column;align-items:center;justify-content:center;border:2px dashed #93c5fd;border-radius:12px;padding:32px;cursor:pointer;background:#f0f7ff;transition:all .2s;">',
            '    <i class="fas fa-file-excel" style="font-size:40px;color:#22c55e;margin-bottom:10px;"></i>',
            '    <span style="font-size:15px;font-weight:700;color:#374151;">クリックまたはドラッグ&amp;ドロップ</span>',
            '    <span style="font-size:12px;color:#6b7280;margin-top:4px;">.xlsx / .xls</span>',
            '    <div id="bom-file-name" style="margin-top:8px;font-size:12px;color:#3b82f6;font-weight:600;max-width:300px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;"></div>',
