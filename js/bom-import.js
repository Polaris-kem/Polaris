...
(function () {
    ...
    function buildHTML() {
        return [
            ...
            '    <div>',
            '      <label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:6px;letter-spacing:0.03em;">工事番号 <span style="color:#ef4444">*</span></label>',
            '      <input id="bom-constructno" type="text" class="form-input" style="width:100%;box-sizing:border-box;" placeholder="例: 1001">',
            '    </div>',
            '    <div>',
            '      <label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:6px;letter-spacing:0.03em;">受注登録日（KeyDate）</label>',
            '      <input id="bom-keydate" type="date" class="form-input" style="width:100%;box-sizing:border-box;">',
            '    </div>',
            '    <div>',
            '      <label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:6px;letter-spacing:0.03em;">データ開始行</label>',
            '      <input id="bom-start-row" type="number" class="form-input" style="width:100%;box-sizing:border-box;" value="' + _headerStartRow + '" min="1" max="50" onchange="window._bomChangeStartRow(parseInt(this.value))">',
            '    </div>',
            '    <div id="bom-drop-area" style="display:flex;flex-direction:column;align-items:center;justify-content:center;border:2px dashed #d1d5db;border-radius:10px;padding:10px 20px;cursor:pointer;background:#f8faff;transition:all .2s;min-width:160px;">',
            '      <i class="fas fa-file-excel" style="font-size:22px;color:#22c55e;margin-bottom:4px;"></i>',
            '      <span style="font-size:12px;font-weight:600;color:#374151;">ファイルを選択</span>',
            '      <div id="bom-file-name" style="margin-top:3px;font-size:11px;color:#3b82f6;font-weight:500;max-width:150px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;"></div>',
